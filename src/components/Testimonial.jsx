        ...
        <section className="bg-white dark:bg-transparent">
            <div className="container mx-auto">
                <div className="mt-6 md:flex md:items-center md:justify-between">
                    <div>
                        ...
                        <div className="flex mx-auto mt-6">
                            <span className="inline-block w-40 h-1  bg-gradient-to-r from-violet-900 via-purple-900 to-pink-900 rounded-full" />
                            <span className="inline-block w-3 h-1 mx-1  bg-gradient-to-r from-pink-900  to-pink-950 rounded-full" />
                            <span className="inline-block w-1 h-1  bg-violet-950 rounded-full" />
                        </div>
                    </div>
                ...
                <section className="grid grid-cols-1 gap-8 mt-8 xl:mt-12 lg:grid-cols-2 xl:grid-cols-3">
                    <div className="p-8 hover:bg-gradient-to-tr from-violet-900 via-black dark:black to-purple-900 border rounded-lg dark:border-gray-700">
                    ...
                    <div className="p-8 hover:bg-gradient-to-tr from-violet-900 via-black dark:black to-purple-900 border border-transparent rounded-lg">
