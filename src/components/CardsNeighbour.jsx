  ...
  return (
    <div className='bg-gradient-to-tr from-purple-950 via-pink-900 to-violet-950
            ...
            <div className='w-full h-full bg-black p-6 m-0  group-hover:rounded-2xl group groups duration-500 overflow-hidden'>
                ...
                <span className='font-bold text-violet-900 text-3xl'>Xenture</span> brings over 7 years of experience in the FinTech sector, a solid track record, and enduring integration background in enterprise-grade projects to our clients disposal
                </p>
                <ClickButton/>
             </div>
            </div>
